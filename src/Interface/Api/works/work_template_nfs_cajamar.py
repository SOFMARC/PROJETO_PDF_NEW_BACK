...
def work_template_nfs_cajamar(file, filename, filepathimage):
    ...
    try:
        ...
        data = {
            "cnpj_tomador": busca_cpf_cnpj_tdr.group(),
            "razao_tomador": busca_razao_tdr.group(),
            "insc_mun_tomador": busca_inscricao_tdr.group(),
            "endereco_tomador": busca_endereco_tdr.group(),
            "cnpj_prestador": busca_cpf_cnpj_ptd.group(),
            "razao_prestador": busca_razao_ptd.group(),
            "insc_mun_prestador": busca_inscricao_ptd.group(),
            "endereco_prestador": busca_endereco_ptd.group(),
            "local_incidencia_imposto": empy_text_column,
            "descricao_atividades": clear_blank_lines(busca_descricao.group()),
            "porcentagem": empy_text_column,
            "servicos": empy_text_column,
            "deducoes": empy_text_column,
            "base_de_calculo": array_clear_empty_2[12],
            "inss": array_clear_empty[9],
            "iss_retido": empy_text_column,
            "endereco_obra": busca_local_obra.group(),
            "cno": empy_text_column,
            "codigo_servico": clear_blank_lines(busca_codigo_servico.group()),
            "valor_total_deducoes": total.split(' ')[1].replace('\n', ''),
            "aliquota": array_clear_empty_2[13],
            "valor_total_nota": line_valor_total.group(),
            "valor_iss": array_clear_empty_2[14],
            "ir": array_clear_empty[8]
        }
