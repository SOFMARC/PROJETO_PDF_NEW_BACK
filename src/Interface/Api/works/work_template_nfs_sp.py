...
from src.Interface.Api.utils.clear import clear_jump_lines
...
def work_template_nfs_sp(file, filename, filepathimage):
    ...
    try:
      ...
      data = {
          "cnpj_tomador": clear_blank_lines(clear_blank_lines(busca_tomador_cpf_cnpj_v2.group())),
          "razao_tomador": clear_blank_lines(busca_tomador_nome.group()),
          "insc_mun_tomador": clear_blank_lines(busca_tomador_inscricao.group()),
          "endereco_tomador": clear_blank_lines(busca_tomador_endereco.group()),
          "cnpj_prestador": clear_blank_lines(clear_blank_lines(busca_prestador_cpf_cnpj_v2.group())),
          "razao_prestador": clear_blank_lines(busca_prestador_nome.group()),
          "insc_mun_prestador": clear_blank_lines(busca_prestador_incricao.group()),
          "endereco_prestador": clear_blank_lines(busca_prestador_endereco.group()),
          "local_incidencia_imposto": clear_blank_lines(busca_local.group() if busca_local else empy_text_column),
          "descricao_atividades": clear_blank_lines(empy_text_column),
          "porcentagem": clear_blank_lines(empy_text_column),
          "servicos": clear_blank_lines(empy_text_column),
          "deducoes": clear_blank_lines(empy_text_column),
          "base_de_calculo": clear_blank_lines(base_calculo),
          "inss": clear_blank_lines(empy_text_column),
          "iss_retido": clear_blank_lines(empy_text_column),
          "endereco_obra": clear_blank_lines(busca_local_obra.group() if busca_local_obra else empy_text_column),
          "cno": clear_blank_lines(busca_cno.group() if busca_cno else empy_text_column),
          "codigo_servico": clear_blank_lines(clear_blank_lines(busca_codigo_serico.group())),
          "valor_total_deducoes": clear_blank_lines(valor_total_deducoes),
          "aliquota": clear_blank_lines(aliquota),
          "valor_total_nota": clear_blank_lines(empy_text_column),
          "valor_iss": clear_blank_lines(valor_iss),
          "ir": clear_blank_lines(irrf)
      }
