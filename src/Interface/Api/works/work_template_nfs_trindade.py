...
def work_template_nfs_trindade(file, filename, filepathimage):
    ...
    try:
        ...
        data = {
            "cnpj_tomador": clear_blank_lines(array_cnpj_pretacao[0]),
            "razao_tomador": clear_blank_lines(busca_razao_tomador.group()),
            "insc_mun_tomador": clear_blank_lines(array_cnpj_pretacao[1]),
            "endereco_tomador": clear_blank_lines(busca_endereco_tomador.group()),
            "cnpj_prestador": clear_blank_lines(array_cnpj_incricao[0]),
            "razao_prestador": clear_blank_lines(busca_razao_prestador.group()),
            "insc_mun_prestador": clear_blank_lines(array_cnpj_incricao[1]),
            "endereco_prestador": clear_blank_lines(busca_endereco_prestador.group()),
            ...
            "servicos": clear_blank_lines(array_line_valor[0]),
            "deducoes": clear_blank_lines(array_line_valor[1]),
            "base_de_calculo": clear_blank_lines(array_line_valor[3]),
            "inss": clear_blank_lines(array_line_imposto[4]),
            "iss_retido": clear_blank_lines(array_line_aliquota[2]),
            ...
            "aliquota": clear_blank_lines(array_line_aliquota[0]),
            "valor_total_nota": clear_blank_lines(empy_text_column),
            "valor_iss": clear_blank_lines(array_line_aliquota[1]),
            "ir": clear_blank_lines(array_line_imposto[0])
        }
